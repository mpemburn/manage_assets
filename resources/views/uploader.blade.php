<div class="" style="width: 90%;">
    <main class="container mx-auto max-w-screen-lg h-full">
        <!-- file upload modal -->
        <article id="dropper" aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" >
            <!-- overlay -->
...
<template id="file-template">
    <li class="block p-1 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8 h-44">
              ...
              <span class="p-1 text-blue-800">
                <i>
                  <svg class="fill-current w-4 h-4 ml-auto pt-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <button class="delete ml-auto pointer focus:outline-none hover:bg-gray-300 p-1 rounded-md text-gray-800">
